-- ============================================
-- הוספת תמונות אמיתיות ליעדים
-- סקריפט זה מעדכן את ה-image_url של יעדים נפוצים עם תמונות מ-Unsplash
-- ============================================

-- הערה: החלף את '4af931ea-e4f8-4728-9d82-30de9b2f2b14' במזהה הסוכנות שלך
-- למציאת המזהה: SELECT id FROM agencies LIMIT 1;
-- מזהה הסוכנות שלך: 4af931ea-e4f8-4728-9d82-30de9b2f2b14
...
-- SELECT name, image_url FROM destinations WHERE agency_id = '4af931ea-e4f8-4728-9d82-30de9b2f2b14' AND image_url IS NOT NULL;
